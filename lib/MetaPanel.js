...
WfmMetaPanel.prototype.drawMpxSpectrum = function(spectrum) {
    ...
    spectrum.forEach(function(value, index) {
        ...
        var y = (height - 17) * (1 - Math.max(0, Math.min(100, value)) / 100);
        if (index) context.lineTo(x, y); else context.moveTo(x, y);
    });
    context.stroke();
    context.fillStyle = '#789481';
    context.font = '9px monospace';
    context.textBaseline = 'bottom';
    context.fillText('0', 2, height);
    context.fillText('19', width * 19 / 92 - 6, height);
    context.fillText('57 RDS', width * 57 / 92 - 18, height);
    context.textAlign = 'right';
    context.fillText('92 kHz', width - 2, height);
};
    ...
    if (enabled) {
        $(this.el).removeClass('disabled').html(
            '<div class="rds-container">' +
                ...
                '<div class="rds-mpx-spectrum-wrap"><span>MPX SPECTRUM · 0–92 kHz</span><canvas class="rds-mpx-spectrum" width="460" height="92"></canvas></div>' +
