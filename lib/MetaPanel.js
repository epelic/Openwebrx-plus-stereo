...
function DabMetaPanel(el) {
    ...
    var $container = $(
        '<div class="dab-container"><div class="dab-info-column">' +
            ...
            '<div class="dab-logo-column dab-station-column"><div class="dab-logo-title">DAB STATION</div>' +
                ...
                '<button type="button" class="dab-stereo-toggle">STEREO</button>' +
            '</div></div>'
    );
    ...
    this.dabMono = false;
    $(this.el).find('.dab-stereo-toggle').on('click', function() {
        me.dabMono = !me.dabMono;
        if (window.audioEngine && audioEngine.setDabMono) audioEngine.setDabMono(me.dabMono);
        $(this).text(me.dabMono? 'MONO' : 'STEREO').toggleClass('active', me.dabMono);
    });
