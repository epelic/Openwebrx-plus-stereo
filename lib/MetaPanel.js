...
function DabMetaPanel(el) {
    ...
    var $container = $(
        '<div class="dab-container"><div class="dab-info-column">' +
            ...
            '</div></div>' +
            '<div class="dab-mot-column"><div class="dab-mot-title">MOT SLIDESHOW</div>' +
                '<div class="dab-mot-frame"><img class="dab-mot-image" alt="DAB MOT Slideshow" />' +
                '<span class="dab-mot-status">In attesa di MOT</span></div>' +
            '</div></div>'
    );
...
DabMetaPanel.prototype.update = function(data) {
    ...
    if (data.mot_image) {
        $(this.el).find('.dab-mot-image').attr('src', data.mot_image).show();
        $(this.el).find('.dab-mot-status').hide();
    }
};
...
DabMetaPanel.prototype.clear = function() {
    ...
    $(this.el).find('.dab-mot-image').removeAttr('src').hide();
    $(this.el).find('.dab-mot-status').show();
};
